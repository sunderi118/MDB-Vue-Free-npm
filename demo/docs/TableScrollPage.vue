<template>
  <container>
    <row class="mt-5 align-items-center justify-content-start">
      ...
      <a href="https://mdbootstrap.com/vue/content/table-scroll/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Docs</a>
    </row>
    <hr />
    ...
    <br />
    <h3>Datatable horizontal scroll</h3>
    <br />
    <mdb-datatable
      :data="data"
      striped
    ...
    <br />
    <h3>Datatable horizontal and vertical scroll</h3>
    <br />
    <mdb-datatable
      :data="data"
      striped
