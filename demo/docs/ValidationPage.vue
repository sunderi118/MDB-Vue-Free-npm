<template>
  <container>
    <row class="mt-5 align-items-center justify-content-start">
      ...
      <a href="https://mdbootstrap.com/vue/components/form-validation/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Docs</a>
    </row>
    <hr />
    <container class="mt-5">
      ...
      <!-- Supported elements -->
      <hr class="my-5">
      <h2 class="my-5">Supported elements</h2>
