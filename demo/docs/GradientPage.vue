<template>
  <mdb-container class="mt-5">
    <mdb-row class="mt-5">
      <h4 class="grey-text"><strong>Gradient </strong></h4>
      <a href="https://mdbootstrap.com/vue/css/gradient/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><mdb-icon icon="graduation-cap" class="mr-2"/>Docs</a>
    </mdb-row>
    <hr class="mb-5" />
