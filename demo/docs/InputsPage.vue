<template>
  <container>
    <row class="mt-5 align-items-center justify-content-start">
      ...
      <a href="https://mdbootstrap.com/vue/components/inputs/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Docs</a>
    </row>
    <hr />
    <container class="mt-5">
      ...
      <div style="margin-top:3rem;max-width:20rem">
        <numeric-input :max="10" :emptyValue="5" minus @input="handleInput" /><br/>
...
<script>
import { mdbInput, MdTextarea, Container, NumericInput, Row, Fa } from "mdbvue";
