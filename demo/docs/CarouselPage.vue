<template>
  <container>
    <row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Carousel</strong></h4>
      <a href="https://mdbootstrap.com/vue/advanced/carousel/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Docs</a>
    </row>
    <hr />
...
<script>
import { Carousel, CarouselItem, CarouselCaption, Row, Fa, Container } from 'mdbvue';
